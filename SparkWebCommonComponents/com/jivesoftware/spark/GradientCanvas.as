package com.jivesoftware.spark {
	 ...
	 * @licence
	 * This component is released under the Creative Commons 2.
	 * Follow the following lik to read the content of this licence :
	 * 
	 * 	http://creativecommons.org/licenses/by/2.0/fr/deed.en
	 * 
	 * Just give my name and a link to my blog.
	 * 
	 * @version 1.0
	 * 1st release
	 *  
			...
			*/
			...
			if (getStyle('fillAlphas') != undefined) {
				...
				// build the default value array of alphas according to the number of colors
					...
					for ( i = 0; i < _colorsconfig.length; i++) {
						arr = new Array();
						for (var j:Number = 0 ; j < _colorsconfig[i] ; j++) {
